...
const IDProofReUpload = () => {
  ...
  return (
    <div className="upload-container">
      ...
      <p>Your previously uploaded ID proof is under review. If there are any issues with the document, please re-upload a valid government-issued ID proof for verification. Accepted formats include PDF, JPG, and PNG, with a maximum file size of 5MB.</p>
      <h2>ReUpload Your ID Proof</h2>
...
export default IDProofReUpload;
